...
<body class="bg-t2 center">
    ...
    <div class="row flex-row wrap">
        <div class="bucket img1-t2 center">10kg 감량하기</div>
        <div class="bucket img2-t2 center">스터디미니 완공</div>
        <div class="bucket img2-t2 cente r">링피트 완주</div>
        <div class="bucket img1-t2 center">보컬 트레이닝 받기</div>
        <div class="bucket img1-t2 center">피아노 완곡 연습하기</div>
        <div class="bucket img2-t2 center">손톱 물어 뜯지 않기</div>
    </div>
